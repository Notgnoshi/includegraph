...
def assert_graph_equal(lhs, rhs):
    # TODO: This should actually be a more intelligent comparison, with more meaninful error
    # messages (that know about nodes and edges)
    lhs_tgf = io.StringIO()
    output_dep_graph_tgf(lhs, lhs_tgf)
    rhs_tgf = io.StringIO()
    output_dep_graph_tgf(rhs, rhs_tgf)
    assert lhs_tgf.getvalue() == rhs_tgf.getvalue()
